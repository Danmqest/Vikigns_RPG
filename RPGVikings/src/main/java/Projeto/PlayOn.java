...
public class PlayOn {
    ...
    static void Menu() {
        ...
        System.out.println("\n A missão de encontrar o amigo do rei é  uma missão quase que suicida o "+ playUm +" tem que  atravessa um extenso território gelado onde ele nunca tinha passado.\n+"
        ...
        System.out.println("Apos essa missão solitaria e suicida o jogadorr retorna ao reino e pede reforços ao rei para continuar.\n+"
